...
module ``about filtering`` =
    ...
    let FilteringAList() =
        ...
        let actual_names = names |> List.filter (fun name -> name.StartsWith("A"))

        AssertEquality actual_names [ "Alice" ]

        //Or passing a function to filter
        let startsWithTheLetterB (s: string) = s.StartsWith("B")

        let namesBeginningWithB = names |> List.filter startsWithTheLetterB
    ...
    let FindingJustOneItem() =
        ...
        let actual_name = names |> List.find (fun name -> name = "Bob")
    ...
    let FindingJustOneOrZeroItem() =
        ...
        let eve = names |> List.tryFind (fun name -> name = "Eve")
        let zelda = names |> List.tryFind (fun name -> name = "Zelda")
    ...
    let ChoosingItemsFromAList() =
        ...
        let evenNumbers = numbers |> List.choose someIfEven
        ...
        let namesWithValue = optionNames |> List.choose id
    ...
    let PickingItemsFromAList() =
        ...
        let firstEven = numbers |> List.pick someIfEven
        ...
        let firstNameWithValue = optionNames |> List.pick id
